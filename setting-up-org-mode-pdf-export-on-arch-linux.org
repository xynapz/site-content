...
The =fontspec= package is fantastic for modern LaTeX documents—it lets you use system fonts directly and handles Unicode properly. But it fundamentally doesn't work with pdfLaTeX.
